...
if($action == '"http://www.microsoft.com/SoftwareDistribution/Server/ClientWebService/SyncUpdates"') {
    $out = str_replace('ProductType="1" /&gt;&lt;Not&gt;&lt;b.WindowsVersion Comparison="EqualTo" SuiteMask="64" /&gt;&lt;/Not&gt;', 'ProductType="1" /&gt;&lt;b.WindowsVersion Comparison="EqualTo" SuiteMask="64" /&gt;', $out);
